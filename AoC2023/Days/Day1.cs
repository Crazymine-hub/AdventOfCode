...
namespace AdventOfCode.Days
{
    public class Day1: DayBase
    {
        ...
        private string GetDigitValue(string line, (int index, string digit) digit1Data)
        {
            if (char.IsDigit(line[digit1Data.index]))
                return line[digit1Data.index].ToString();
            else
                return (digits.IndexOf(digit1Data.digit) + 1).ToString();
        }
    }
}
